...
/**
 * 
 * @Class:com.sydt.base.redis.RedisUtil.java
 * @Description:内存数据库Redis的辅助类，负责对内存数据库的所有操作
 * @version:v1.0
 * @author:mHuang
 * @date:2014-7-18 下午3:05:59
 */
...
public class RedisUtil {
	...
	/**
	 * 执行器，{@link org.common.redis.futurefleet.framework.base.redis.RedisUtil}的辅助类，
